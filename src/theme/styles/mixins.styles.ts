...
import { mediaQueries, remToPx, varAlpha } from "./utils.styles";
...
export function paper({ theme, color, dropdown }: PaperProps) {
  return {
    ...
    // backgroundImage: `url(${process.env.ASSET_PREFIX}/assets/cyan-blur.png), url(${process.env.ASSET_PREFIX}/assets/red-blur.png)`,
