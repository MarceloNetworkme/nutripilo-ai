...
import { IconSize } from "../../../components/fa-icon/fa-icon.component";
...
const MuiButton: Components<Theme>["MuiButton"] = {
  ...
  styleOverrides: {
    ...
    iconSizeSmall: {
      "& svg": { fontSize: IconSize.Small },
    },
    iconSizeMedium: {
      "& svg": { fontSize: IconSize.Medium },
    },
    iconSizeLarge: {
      "& svg": { fontSize: IconSize.Large },
    },
    /**
     * @variant outlined
     */
    ...
    sizeSmall: ({ ownerState }) => ({
      height: 30,
      ...(ownerState.variant === "text" ? { paddingLeft: "4px", paddingRight: "4px" } : { paddingLeft: "8px", paddingRight: "8px" }),
    }),
    sizeMedium: ({ ownerState }) => ({
      ...(ownerState.variant === "text" ? { paddingLeft: "8px", paddingRight: "8px" } : { paddingLeft: "12px", paddingRight: "12px" }),
    }),
    sizeLarge: ({ ownerState }) => ({
      height: 48,
      ...(ownerState.variant === "text" ? { paddingLeft: "10px", paddingRight: "10px" } : { paddingLeft: "16px", paddingRight: "16px" }),
    }),
  },
};
...
export const button = { MuiButtonBase, MuiIconButton, MuiButton };
